                ...
                <div class="col-md-12">
                    <div class="card strpied-tabled-with-hover">
                        <div class="card-header ">
                            ...
                            @php
                                 $idmember = empty($search_id[0]->idmember) ? '' : $search_id[0]->idmember;
                            @endphp

                                    @if($idmember != "")
                                        
                                    <a  target ="_blank"  href="{{url('pdf_leave', $idmember) }}"  class="btn btn-outline-info" role="button" aria-pressed="true">PDF</a>
                                        ...
                                        <td>
                                            <div id="image">
                                                <a href="#modal" data-toggle="modal" data-target="#modalimage">
                                                    <img id="myImg"
                                                        src="{{ URL::to('/') }}/public/img/file/{{$ticket1->image}}"
