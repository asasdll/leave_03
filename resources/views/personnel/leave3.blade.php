                                                ...
                                                <td>
                                                    <div id="image">
                                                        <a href="#modal" data-toggle="modal" data-target="#modalimage">
                                                            <img id="myImg" src="{{ URL::to('/') }}/public/img/file/{{$ticket1->image}}" width="30px" height="30px"/>
                                                        </a>
                                                    </div>
                                              </td>  
                                        ...
                                        @foreach($leave2 as $ticket2)
                                            <tr>
                                                ...
                                                <td>
                                                    <div id="image">
                                                        <a href="#modal" data-toggle="modal" data-target="#modalimage">
                                                            <img id="myImg" src="{{ URL::to('/') }}/public/img/file/{{$ticket2->image}}" width="30px" height="30px"/>
                                                        </a>
                                                    </div>
                                                </td>
