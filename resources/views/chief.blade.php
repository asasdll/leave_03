                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form>
                                ...
                                <div class="row">
                                    <div class="col-md-6 pl-1">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="date" value="ปป-ดด-วว"
                                                id="example-date-input" value="{{$ticket->date}}">
                                        </div>
                                    </div>
                                    <div class="col-md-6 pr-1">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-8 pr-1">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control " placeholder="Tel3"
                                                value="{{$ticket->tel3}}">
                                        </div>
                                    </div>
                                    <div class="col-md-4 pl-1">
                                ...
                                <a href="{{action('MemberuserController@edit',$ticket->id)}}"
                            ...
                            <div class="author">
                                <a href="#">
                                    ...
                                    <img class="avatar border-gray"
                                        src="{{ URL::to('/') }}/public/img/profile/{{$ticket->image}}" alt="...">
